...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./assets/basicv2.css" media="screen" rel="stylesheet" type="text/css">


    <!--[if (gte IE 9) | (!IE)]><!-->
    <link rel="stylesheet" href="../npm/main/node_modules/bootstrap/dist/css/bootstrap.css">
    <link rel="stylesheet" href="../npm/main/node_modules/bootstrap/dist/css/bootstrap-theme.css">
    <script type="text/javascript" src="../npm/main/node_modules/jquery/dist/jquery.js"></script>
    <script type="text/javascript" src="../npm/main/node_modules/bootstrap/dist/js/bootstrap.js"></script>
    <!--<![endif]-->

    <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
    <!--[if lt IE 9]>

    <link rel="stylesheet" href="../npm/old/node_modules/bootstrap/dist/css/bootstrap.css">
    <link rel="stylesheet" href="../npm/old/node_modules/bootstrap/dist/css/bootstrap-theme.css">
    <script type="text/javascript" src="../npm/old/node_modules/jquery/dist/jquery.js"></script>
    <script type="text/javascript" src="../npm/old/node_modules/bootstrap/dist/js/bootstrap.js"></script>
...
<div id="main" class="container">
    ...
    <div class="row">
        <div class="col-lg-7">
            ...
            <div id ="infos-txt" class="jumbotron">
                <h1 id="price">HiPay Direct Post Tokenization Simulator</h1>
        ...
        <div id="form" class="col-lg-5">
            ...
            <div class="form-group">
                ...
                <span id="cvv-button" class="input-group-btn pull-right">
            ...
            <div id="submit-container">
                <div id="error"></div>
                <button class="btn btn-large btn-success" type="button" data-toggle="modal" data-target="#other-method-modal" id="pay-button">Tokenize</button>
            </div>
